...
h1_1 <- loadbd3gr("SRR2096446.1")
h1_2 <- loadbd3gr("SRR2096447.1")
h2_1 <- loadbd3gr("SRR2096448.1")
h2_2 <- loadbd3gr("SRR2096449.1")
h3_1 <- loadbd3gr("SRR2096450.1")
h3_2 <- loadbd3gr("SRR2096451.1")
c1_1 <- loadbd3gr("SRR2096452.1")
c1_2 <- loadbd3gr("SRR2096453.1")
c2_1 <- loadbd3gr("SRR2096454.1")
c2_2 <- loadbd3gr("SRR2096455.1")

h1_1 <- saveOv("SRR2096446.1",human1000)
h1_2 <- saveOv("SRR2096447.1",human1000)
h2_1 <- saveOv("SRR2096448.1",human1000)
h2_2 <- saveOv("SRR2096449.1",human1000)
h3_1 <- saveOv("SRR2096450.1",human1000)
h3_2 <- saveOv("SRR2096451.1",human1000)
c1_1 <- saveOv("SRR2096452.1",chimp1000)
c1_2 <- saveOv("SRR2096453.1",chimp1000)
c2_1 <- saveOv("SRR2096454.1",chimp1000)
c2_2 <- saveOv("SRR2096455.1",chimp1000)
